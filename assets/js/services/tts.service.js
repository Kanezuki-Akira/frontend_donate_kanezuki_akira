...
const TtsService = {
      ...
      return [
        {
          ...
          language: 'vi-VN',
          gender: 'Female',
          description: 'Giọng nữ truyền cảm, mượt mà và tự nhiên nhất cho donate stream',
          recommended: true
        },
        {
          ...
          language: 'vi-VN',
          gender: 'Male',
          description: 'Giọng nam trầm ấm, rõ ràng, phát âm chuẩn',
          recommended: false
        },
        {
  ...
  /**
   * Phát trực tiếp câu thoại qua HTML5 Audio
